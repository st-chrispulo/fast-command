...
class Funnel(Base):
    ...
    __table_args__ = (
        Index("idx_tbl_funnels_template_id", "template_id"),
        Index("idx_tbl_funnels_created_at", "created_at"),
        Index("idx_tbl_funnels_images_gin", "images", postgresql_using="gin"),
        ...
        Index("idx_tbl_funnels_metadata_gin", "metadata", postgresql_using="gin"),
    )
