...
class CompLayout(Base):
    ...
    __table_args__ = (
        Index("idx_tbl_comp_layouts_template_id", "template_id"),
        Index("idx_tbl_comp_layouts_created_at", "created_at"),
        Index("idx_tbl_comp_layouts_images_gin", "images", postgresql_using="gin"),
